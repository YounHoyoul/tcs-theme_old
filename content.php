		...
		<header class="entry-header">
			<?php if ( is_sticky() ) : ?>
				<hgroup>
					...
					<h3 class="entry-format"><?php _e( 'Featured', 'tcstheme' ); ?></h3>
				</hgroup>
			<?php else : ?>
			<h1 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'tcstheme' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1>
			<?php endif; ?>
        ...
        <?php elseif ($current_content_layout=='excerpt'  ) : // Only display Featured Image and Excerpts if checked in Theme Option ?>
            <div class="entry-summary">
                <?php if( has_post_thumbnail() ):?>
               		<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'tcstheme' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
