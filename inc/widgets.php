...
class tcs_hp_adwidget extends WP_Widget {
	 ...
	 * @return void
	 **/
	function tcs_hp_adwidget() {
		$widget_ops = array( 'classname' => 'widget_tcs_hp_adwidget', 'description' => __( 'Use this widget to add any type of Ad as a widget.', 'tcstheme' ) );
		$this->WP_Widget( 'widget_tcs_hp_adwidget', __( 'TCS Theme Adspace Widget', 'tcstheme' ), $widget_ops );
		$this->alt_option_name = 'widget_tcs_hp_adwidget';
	}
	...
	function form($instance) {
		...
		?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title (optional):','tcstheme'); ?></label>
            <input type="text" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $title; ?>" class="widefat" id="<?php echo $this->get_field_id('title'); ?>" />
        </p>
        <?php if ( current_user_can( 'unfiltered_html' ) ) : // Only show it to users who can edit it ?>
            <p>
                <label for="<?php echo $this->get_field_id('adcode'); ?>"><?php _e('Ad Code:','tcstheme'); ?></label>
        ...
        <?php endif; ?>
        <p>
            <label for="<?php echo $this->get_field_id('image'); ?>"><?php _e('Image Url:','tcstheme'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('href'); ?>"><?php _e('Link URL:','tcstheme'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('alt'); ?>"><?php _e('Alt text:','tcstheme'); ?></label>
